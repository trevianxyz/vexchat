...
class Utilities:
    ...
    def handle_upload():
        ...
        if uploaded_file is not None:
              ...
              # If no files are uploaded, read the default file at /data/pdfkbcontent.pdf
            with open("data/pdfkbcontent.pdf", "rb") as f:
                uploaded_file = [f]
        ...
        st.sidebar.info("👆 Upload your PDF file to get started..!")
